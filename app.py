            ...
            for file in files:
                ...
                if file_type.startswith("image"):
                    ...
                    if not image_bytes:
                        ...
                        return
                    uploaded_image_data = {"mime_type": "image/jpeg", "data": image_bytes}
        ...
        if message.content:
            ...
            if uploaded_image_data:
                try:
                    ...
                    await cl.Message(content=response.text if response.text else "❌ No relevant response from the image.").send()
